package com.inke.runtimepermission.aop.aspect;
...
import com.inke.runtimepermission.aop.LoginActivity;
...
public class LoginCheckAspect {
    ...
    @Pointcut("execution(@com.inke.runtimepermission.aop.annotation.LoginCheck * *(..))")
